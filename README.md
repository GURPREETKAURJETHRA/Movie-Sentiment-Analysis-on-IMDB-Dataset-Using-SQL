# Movie-Sentiment-Analysis-on-IMDB-Dataset-Using-SQL
SQL queries performed on IMDb database to provide recommendations to RSVP Movies based on insights.

# IMDB-Movie-Data-Analysis
Contains the IMDB movie assignment I've done, as a part of Executive Post-Graduate Programme in Data Science from Upgrad, in collaboration with International Institute of Information Technology,Bangalore (IIIT-B).
